...
class CustomCocoDataset(Dataset):
    def __init__(self, dataset_dir, annotations_file, transform=None, tokenizer=None, shuffle_tokens=False):
        self.image_dir = osp.join(dataset_dir, "images")
    ...
    def __getitem__(self, index):
        ...
        corner_coords = []
        corner_mask = np.zeros((img['height'], img['width']), dtype=np.float32)
...
class CustomCocoDataset_val(Dataset):
    def __init__(self, cfg, dataset_dir, annotations_file, transform=None, tokenizer=None, shuffle_tokens=False):
        self.CFG = cfg
        self.image_dir = osp.join(dataset_dir, "images")
        self.annotations_path = annotations_file
        self.transform = transform
...
class CustomCocoDatasetTest(Dataset):
